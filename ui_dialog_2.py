...
class Dialog_2(QtWidgets.QDialog, Ui_Dialog_2):
    def __init__(self, parent=None):
        ...
        # self.tbw_draw.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.Stretch)
...
# ======================================================自定义方法======================================================
    ...
    def display_1(self, worksheet):
        ...
        #     source_item = QtWidgets.QTableWidgetItem(row[0])  # 源头
        #     self.tbw_draw.setItem(row_num - 1, 0, source_item)

        #     usage_item = QtWidgets.QTableWidgetItem(row[1])  # 用途
        #     self.tbw_draw.setItem(row_num - 1, 1, usage_item)

        #     try:
        #         value_item = QtWidgets.QTableWidgetItem(str(round(float(row[2]), 3)))  # 值
        #     except:
        #         value_item = QtWidgets.QTableWidgetItem(str(row[2]))  # 值
        #     self.tbw_draw.setItem(row_num - 1, 2, value_item)
